...
<legend class="cal_legend"><span class="single">{h:lan_location_details}</span></legend>
<table class="fieldset_content" align="center" border="0" width="430px">				
<tr valign="top">
    <td width="45%" class="cal_right">{h:lan_location_name}:</td>
    <td></td>
    <td class="cal_left"><label type="text">{h:location_name}</label></td>
</tr>
<tr valign="top">
    <td class="cal_right">{h:lan_location_description}:</td>
    <td></td>
    <td class="cal_left"><label type="text">{h:location_description}</label></td>
</tr>
<tr valign="top">
