...
<?php
    ...
    ## *** //CA defined: RELATIVE PATH -> 'calendar/'
    ...
    $objCalendar->SetWeekStartedDay('2');
    ...
    $objCalendar->SetDefaultView('weekly');
    ...
    $events_display_type = array('daily'=>'block', 'weekly'=>'inline', 'monthly'=>'tooltip');
